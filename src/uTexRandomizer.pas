...
begin
  try
    ...
    on E: Exception do
        Util.Log.Add('Błąd wczytywania reguł (starter\reguly.txt). Szczegóły błędu: ' + E.Message);
  end;
end;
...
begin
  Result := TList<Integer>.Create;
    ...
    on E: Exception do
        Util.Log.Add('Błąd wyszukiwania tekstur. Szczegóły błędu: ' + E.Message);
  end;
end;
...
begin
  try
    ...
    on E: Exception do
        Util.Log.Add('Błąd edycji pojazdu. Szczegóły błędu: ' + E.Message);
  end;
end;
